  ...
  <%@include file="common/cartModal.jsp" %>
 			...
 			<ol class="breadcrumb text-right" id="info">
				<c:if test="${sessionScope['_LOGIN_USER_']==null}">
					<li id="li1"><span>Small daisy欢迎您！</span>
					<a href="#loginFormModal" data-toggle="modal">[登录]</a>&nbsp;<a href="#regFormModal" 
					data-toggle="modal">[新用户注册]</a></li>
					
					<li><a href="#" onclick="showCart('${pageContext.request.contextPath}','${sessionScope.goodslist}')">
					购物车 <span class="badge" id="cartBadge">${fn:length(sessionScope.goodslist)}</span></a></li>
					
				</c:if>
				<c:if test="${sessionScope['_LOGIN_USER_']!=null}">
					<li id="li1"><span>${sessionScope['_LOGIN_USER_'].userName } Small daisy欢迎您！</span>										
			...
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="${pageContext.request.contextPath}/index.action"><span class="logo">Small daisy</span> </a>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-2">
					<img alt="" src="${pageContext.request.contextPath}/img/other/title.png"width="120px" height="100px"/>
				</div>
			</div>